...
if [ -e "$file" ]; then
    ...
    #/home/dwk/project/egalito/egalito-spec4/app/build_x86_64/etcet -c $program $file
    ln -sf /home/egalito/egalito-uniongen/app/libcet.so
    /home/egalito/egalito-uniongen/app/etharden -u --cet-const $program $file
    exit 1
fi
